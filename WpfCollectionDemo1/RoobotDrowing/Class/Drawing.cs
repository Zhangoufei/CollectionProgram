...
namespace WindowsForms.Class
{
    public class Drawing
    {
        ...
        //轨迹点
        private List<CanvasItemWinform> m_items = new List<CanvasItemWinform>();  // 所有线条
        private CanvasItemWinform m_currentItem;
        ...
        private void onBeginDraw(ref PointF p,int status)
        {
            m_bDrawing = true;
            m_lastPoint = p;
            CanvasItemWinform item = new CanvasItemWinform();
    ...
    public struct CanvasItemWinform
    {
