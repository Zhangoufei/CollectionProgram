...
namespace 倒计时
{
    public class FlipClock : Control
    {
        ...
        static FlipClock()
        {
            ...
            //DefaultStyleKeyProperty.OverrideMetadata(typeof(FlipClock), new FrameworkPropertyMetadata(typeof(FlipClock)));

            //DefaultStyleKeyProperty.OverrideMetadata(typeof(FlipNumber), new FrameworkPropertyMetadata(typeof(FlipNumber)));
